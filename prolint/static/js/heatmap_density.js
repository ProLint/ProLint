...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addElement(createElement("span", {
        id: 'density_warning',
        innerHTML: '<span>Warning: file size <span style="color: red; font-weight: 900">~15MB</span></span>'
    }))
    ...
    document.getElementById('slice_direction').hidden = true;
    // document.getElementById('slice_direction').disabled = true;
    ...
    var isolevelCHOLText = createElement("div", {
        id: 'lipid_isolevel'
    })
