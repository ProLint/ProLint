...
def residence_time(c, ln, time, delta_t_range=None, range_type='mixed', step=None):
    """Calculate Residence Time. See the following sources for a detailed explanation:
    https://pubs.acs.org/doi/abs/10.1021/ja310577u and https://www.pnas.org/content/117/14/7803

    This is a rudimentary function to calcualte residence time. It is an adaptation of the same
    function as implemented here: https://github.com/wlsong/PyLipID
